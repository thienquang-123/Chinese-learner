const vocab = [
    ...
    { chinese: "春", pinyin: "chūn", english: ["spring"], vietnamese: ["mùa xuân", "xuân"] },
    { chinese: "春天/春季", pinyin: "chūn tiān/chūn jì", english: ["spring"], vietnamese: ["mùa xuân"] },
    { chinese: "春节", pinyin: "chūn jié", english: ["Spring Festival"], vietnamese: ["Tết Nguyên Đán", "Tết"] },
    { chinese: "晴", pinyin: "qíng", english: ["sunny", "clear weather"], vietnamese: ["nắng", "trời quang"] },
    { chinese: "晴天", pinyin: "qíng tiān", english: ["sunny day"], vietnamese: ["ngày nắng", "trời nắng"] },
    { chinese: "街", pinyin: "jiē", english: ["street"], vietnamese: ["phố", "đường phố", "nhai"] },
    { chinese: "大街", pinyin: "dà jiē", english: ["avenue", "main street"], vietnamese: ["đại lộ", "đường lớn"] },
    { chinese: "街头", pinyin: "jiē tóu", english: ["street corner", "streetside"], vietnamese: ["đầu đường", "trên phố"] },
    { chinese: "医", pinyin: "yī", english: ["medical", "to cure"], vietnamese: ["y"] },
    { chinese: "中医", pinyin: "zhōng yī", english: ["Chinese medicine"], vietnamese: ["Đông y", "Trung y"] },
    { chinese: "西医", pinyin: "xī yī", english: ["Western medicine"], vietnamese: ["Tây y"] },
    { chinese: "医学", pinyin: "yī xué", english: ["study of medicine", "medical science"], vietnamese: ["y học"] },
    { chinese: "医生", pinyin: "yī shēng", english: ["doctor"], vietnamese: ["bác sĩ"] },
    { chinese: "短", pinyin: "duǎn", english: ["short"], vietnamese: ["ngắn", "đoản"] },
    { chinese: "短期", pinyin: "duǎn qī", english: ["short-term"], vietnamese: ["ngắn hạn", "thời gian ngắn"] },
    { chinese: "长短", pinyin: "cháng duǎn", english: ["length"], vietnamese: ["độ dài", "dài ngắn"] },
    { chinese: "商", pinyin: "shāng", english: ["business", "commerce"], vietnamese: ["kinh doanh", "thương mại", "thương"] },
    { chinese: "商人", pinyin: "shāng rén", english: ["businessman", "merchant"], vietnamese: ["thương nhân", "doanh nhân"] },
    { chinese: "经商", pinyin: "jīng shāng", english: ["to be in business", "to trade"], vietnamese: ["kinh doanh", "buôn bán"] },
    { chinese: "商店", pinyin: "shāng diàn", english: ["shop", "store"], vietnamese: ["cửa hàng", "cửa hiệu", "thương điếm"] },
    { chinese: "参", pinyin: "cān", english: ["to participate", "to join"], vietnamese: ["tham"] },
    { chinese: "参加", pinyin: "cān jiā", english: ["to participate", "to join"], vietnamese: ["tham gia"] },
    { chinese: "参与", pinyin: "cān yǔ", english: ["to participate in", "to be involved in"], vietnamese: ["tham dự", "tham gia vào"] },
    { chinese: "参考", pinyin: "cān kǎo", english: ["to reference", "to consult"], vietnamese: ["tham khảo"] },
    { chinese: "须", pinyin: "xū", english: ["must", "necessary", "beard"], vietnamese: ["phải", "cần thiết", "râu"] },
    { chinese: "必须", pinyin: "bì xū", english: ["must", "have to"], vietnamese: ["phải", "nhất thiết"] },
    { chinese: "须知", pinyin: "xū zhī", english: ["must know", "guide", "notice"], vietnamese: ["những điều cần biết", "thông tin cần thiết"] },
    { chinese: "颜", pinyin: "yán", english: ["color", "face"], vietnamese: ["màu sắc", "sắc"] },
    { chinese: "颜色", pinyin: "yán sè", english: ["color"], vietnamese: ["màu sắc"] },
    { chinese: "备用", pinyin: "bèi yòng", english: ["backup", "spare", "reserve"], vietnamese: ["dự phòng"] },
    { chinese: "留", pinyin: "liú", english: ["to stay", "to keep"], vietnamese: ["ở lại", "giữ lại", "lưu"] },
    { chinese: "留学", pinyin: "liú xué", english: ["to study abroad"], vietnamese: ["du học"] },
    { chinese: "留学生", pinyin: "liú xué shēng", english: ["overseas student"], vietnamese: ["du học sinh"] },
    { chinese: "保留", pinyin: "bǎo liú", english: ["to keep", "to save", "to reserve"], vietnamese: ["bảo lưu", "giữ lại"] },
    { chinese: "画", pinyin: "huà", english: ["to draw", "painting", "picture"], vietnamese: ["vẽ", "hoạ"] },
    { chinese: "画家", pinyin: "huà jiā", english: ["painter", "artist"], vietnamese: ["họa sĩ"] },
    { chinese: "画面", pinyin: "huà miàn", english: ["scene", "screen", "picture"], vietnamese: ["màn hình", "hình ảnh", "khung cảnh"] },
    { chinese: "条", pinyin: "tiáo", english: ["article", "clause", "measure word for long, thin things"], vietnamese: ["điều", "mục", "con (lượng từ)"] },
    { chinese: "条件", pinyin: "tiáo jiàn", english: ["condition", "qualification"], vietnamese: ["điều kiện"] },
    { chinese: "夏", pinyin: "xià", english: ["summer"], vietnamese: ["mùa hè", "hạ"] },
    { chinese: "夏天/夏季", pinyin: "xià tiān/xià jì", english: ["summer"], vietnamese: ["mùa hè"] },
    { chinese: "复", pinyin: "fù", english: ["to repeat", "to review", "to resume"], vietnamese: ["lặp lại", "ôn tập", "phúc", "phục"] },
    { chinese: "复习", pinyin: "fù xí", english: ["to review"], vietnamese: ["ôn tập", "xem lại"] },
    { chinese: "重复", pinyin: "chóng fù", english: ["to repeat"], vietnamese: ["lặp lại", "trùng lặp"] },
    { chinese: "反复", pinyin: "fǎn fù", english: ["repeatedly", "over and over"], vietnamese: ["lặp đi lặp lại"] },
    { chinese: "种", pinyin: "zhòng / zhǒng", english: ["to plant (v)", "seed / type (n)"], vietnamese: ["trồng", "chủng"] },
    { chinese: "种子", pinyin: "zhǒng zi", english: ["seed"], vietnamese: ["hạt giống"] },
    { chinese: "各种", pinyin: "gè zhǒng", english: ["various", "all kinds of"], vietnamese: ["các loại", "đủ loại"] },
    { chinese: "秋", pinyin: "qiū", english: ["autumn", "fall"], vietnamese: ["mùa thu", "thu"] },
    { chinese: "秋季/秋天", pinyin: "qiū jì/qiū tiān", english: ["autumn season"], vietnamese: ["mùa thu"] },
    { chinese: "中秋节", pinyin: "zhōng qiū jié", english: ["Mid-Autumn Festival"], vietnamese: ["Tết Trung Thu"] },
    { chinese: "烧", pinyin: "shāo", english: ["to burn", "to roast", "to have a fever"], vietnamese: ["đốt", "thiêu"] },
    { chinese: "烧烤", pinyin: "shāo kǎo", english: ["barbecue"], vietnamese: ["đồ nướng", "tiệc nướng"] },
    { chinese: "发烧", pinyin: "fā shāo", english: ["to have a fever", "fever"], vietnamese: ["phát sốt", "bị sốt"] },
    { chinese: "解", pinyin: "jiě", english: ["to take apart", "to solve", "to untie"], vietnamese: ["cởi bỏ", "giải quyết", "giải"] },
    { chinese: "解决", pinyin: "jiě jué", english: ["to solve", "to resolve"], vietnamese: ["giải quyết"] },
    { chinese: "了解", pinyin: "liǎo jiě", english: ["to understand", "to know well"], vietnamese: ["hiểu rõ", "tìm hiểu"] },
    { chinese: "和解", pinyin: "hé jiě", english: ["to reconcile"], vietnamese: ["hòa giải"] },
    { chinese: "般", pinyin: "bān", english: ["sort", "kind", "class"], vietnamese: ["loại", "kiểu", "hạng"] },
    { chinese: "一般", pinyin: "yī bān", english: ["general", "ordinary", "so-so"], vietnamese: ["bình thường", "phổ biến", "nói chung"] },
    { chinese: "骑", pinyin: "qí", english: ["to ride (an animal or bicycle)"], vietnamese: ["cưỡi", "đạp xe", "kỵ", "kị"] },
    { chinese: "疼", pinyin: "téng", english: ["pain", "ache", "to love dearly"], vietnamese: ["đau", "thương yêu"] },
    { chinese: "头疼", pinyin: "tóu téng", english: ["headache"], vietnamese: ["đau đầu"] },
    { chinese: "心疼", pinyin: "xīn téng", english: ["to love dearly", "to feel distressed/sorry for"], vietnamese: ["đau lòng", "xót xa", "thương xót"] },
    { chinese: "痛", pinyin: "tòng", english: ["pain", "ache", "sadness"], vietnamese: ["đau", "thống khổ", "thống"] },
    { chinese: "痛快", pinyin: "tòng kuài", english: ["delighted", "forthright", "to one's heart's content"], vietnamese: ["sảng khoái", "thống khoái"] },
    { chinese: "瘦", pinyin: "shòu", english: ["thin", "skinny", "tight (of clothing)"], vietnamese: ["gầy", "ốm", "chật"] },
    { chinese: "闻", pinyin: "wén", english: ["to hear", "to smell", "news"], vietnamese: ["nghe", "ngửi", "tin tức", "văn", "vấn"] },
    { chinese: "新闻", pinyin: "xīn wén", english: ["news"], vietnamese: ["tin tức", "thời sự"] },
    { chinese: "闻名", pinyin: "wén míng", english: ["famous", "well-known"], vietnamese: ["nổi tiếng", "vang danh"] },
    { chinese: "聪", pinyin: "cōng", english: ["intelligent", "clever", "hearing"], vietnamese: ["thông", "thính"] },
    { chinese: "聪明", pinyin: "cōng ming", english: ["smart", "clever", "intelligent"], vietnamese: ["thông minh"] },
    { chinese: "聊", pinyin: "liáo", english: ["to chat"], vietnamese: ["tán gẫu", "nói chuyện"] },
    { chinese: "聊天(儿)", pinyin: "liáo tiān (r)", english: ["to chat"], vietnamese: ["tán gẫu", "trò chuyện"] },
    { chinese: "无聊", pinyin: "wú liáo", english: ["boring", "bored"], vietnamese: ["nhàm chán", "buồn tẻ"] },
    { chinese: "院", pinyin: "yuàn", english: ["courtyard", "institution"], vietnamese: ["viện"] },
    { chinese: "医院", pinyin: "yī yuàn", english: ["hospital"], vietnamese: ["bệnh viện"] },
    { chinese: "住院", pinyin: "zhù yuàn", english: ["to be hospitalized"], vietnamese: ["nằm viện", "nhập viện"] },
    { chinese: "学院", pinyin: "xué yuàn", english: ["college", "institute"], vietnamese: ["học viện"] },
    { chinese: "院长", pinyin: "yuàn zhǎng", english: ["dean", "director"], vietnamese: ["viện trưởng", "trưởng khoa"] },
    { chinese: "电影院", pinyin: "diàn yǐng yuàn", english: ["movie theater", "cinema"], vietnamese: ["rạp chiếu phim"] },
    { chinese: "除", pinyin: "chú", english: ["to remove", "except", "to divide"], vietnamese: ["trừ", "loại bỏ"] },
    { chinese: "除非", pinyin: "chú fēi", english: ["unless", "only if"], vietnamese: ["trừ khi"] },
    { chinese: "除了... 之外", pinyin: "chú le... zhī wài", english: ["besides", "except for"], vietnamese: ["ngoài ... ra"] },
    { chinese: "随", pinyin: "suí", english: ["to follow", "to comply with"], vietnamese: ["tùy", "theo"] },
    { chinese: "随意", pinyin: "suí yì", english: ["as one pleases", "at will"], vietnamese: ["tùy ý"] },
    { chinese: "随便", pinyin: "suí biàn", english: ["casual", "informal", "as one pleases"], vietnamese: ["tùy tiện", "tùy ý"] },
    { chinese: "随时", pinyin: "suí shí", english: ["anytime", "at any time"], vietnamese: ["bất cứ lúc nào"] },
    { chinese: "怪", pinyin: "guài", english: ["strange", "monster", "to blame"], vietnamese: ["lạ", "quái", "trách"] },
    { chinese: "奇怪", pinyin: "qí guài", english: ["strange", "odd"], vietnamese: ["kỳ lạ", "quái lạ", "kỳ quái"] },
    { chinese: "怪不得", pinyin: "guài bu de", english: ["no wonder"], vietnamese: ["chẳng trách", "hèn chi"] },
    { chinese: "懂", pinyin: "dǒng", english: ["to understand"], vietnamese: ["hiểu"] },
    { chinese: "懂事", pinyin: "dǒng shì", english: ["sensible", "intelligent (of a child)"], vietnamese: ["hiểu chuyện", "biết điều"] },
    { chinese: "性", pinyin: "xìng", english: ["nature", "character", "sex/gender"], vietnamese: ["tính", "giới tính"] },
    { chinese: "个性", pinyin: "gè xìng", english: ["personality", "individuality"], vietnamese: ["cá tính"] },
    { chinese: "性别", pinyin: "xìng bié", english: ["gender", "sex"], vietnamese: ["giới tính"] },
    { chinese: "记性", pinyin: "jì xìng", english: ["memory (ability to remember)"], vietnamese: ["trí nhớ"] },
    { chinese: "费", pinyin: "fèi", english: ["fee", "cost", "to spend"], vietnamese: ["phí", "chi phí", "tiêu tốn"] },
    { chinese: "消费", pinyin: "xiāo fèi", english: ["consumption", "spending"], vietnamese: ["tiêu dùng", "tiêu thụ"] },
    { chinese: "花费", pinyin: "huā fèi", english: ["to spend", "expenditure"], vietnamese: ["tiêu xài", "chi phí"] },
    { chinese: "费用", pinyin: "fèi yòng", english: ["cost", "expense"], vietnamese: ["chi phí", "phí tổn"] },
    { chinese: "赛", pinyin: "sài", english: ["match", "competition", "to race"], vietnamese: ["thi đấu", "giải đấu"] },
    { chinese: "比赛", pinyin: "bǐ sài", english: ["competition", "match"], vietnamese: ["trận đấu", "cuộc thi"] },
    { chinese: "决赛", pinyin: "jué sài", english: ["final (of a competition)"], vietnamese: ["chung kết"] },
    { chinese: "惯", pinyin: "guàn", english: ["accustomed to", "habit"], vietnamese: ["quen", "thói quen"] },
    { chinese: "习惯", pinyin: "xí guàn", english: ["habit", "to be used to"], vietnamese: ["thói quen", "quen với"] },
    { chinese: "望", pinyin: "wàng", english: ["to look at", "to hope", "to visit"], vietnamese: ["nhìn", "vọng", "thăm"] },
    { chinese: "希望", pinyin: "xī wàng", english: ["to hope", "hope"], vietnamese: ["hy vọng", "hi vọng"] },
    { chinese: "失望", pinyin: "shī wàng", english: ["to be disappointed", "to lose hope"], vietnamese: ["thất vọng"] },
    { chinese: "看望", pinyin: "kàn wàng", english: ["to visit", "to see (someone)"], vietnamese: ["thăm hỏi", "đến thăm", "thăm"] },
    { chinese: "型", pinyin: "xíng", english: ["type", "model", "mold"], vietnamese: ["kiểu", "hình", "khuôn"] },
    { chinese: "型号", pinyin: "xíng hào", english: ["model number", "type"], vietnamese: ["loại", "kiểu dáng", "kiểu"] },
    { chinese: "内向型", pinyin: "nèi xiàng xíng", english: ["introverted"], vietnamese: ["hướng nội"] },
    { chinese: "外向型", pinyin: "wài xiàng xíng", english: ["extroverted"], vietnamese: ["hướng ngoại"] },
    { chinese: "努", pinyin: "nǔ", english: ["to put forth effort", "to strive"], vietnamese: ["nỗ", "gắng sức"] },
    { chinese: "努力", pinyin: "nǔ lì", english: ["to try hard", "hardworking", "effort"], vietnamese: ["nỗ lực", "cố gắng"] },
    { chinese: "数", pinyin: "shù / shǔ", english: ["number / to count"], vietnamese: ["số / đếm"] },
    { chinese: "数学", pinyin: "shù xué", english: ["mathematics"], vietnamese: ["toán học"] },
    { chinese: "岁数", pinyin: "suì shu", english: ["age (years)"], vietnamese: ["tuổi tác", "tuổi"] },
    { chinese: "无数", pinyin: "wú shù", english: ["countless", "innumerable"], vietnamese: ["vô số"] },
    { chinese: "大多数", pinyin: "dà duō shù", english: ["great majority", "most"], vietnamese: ["đại đa số", "phần lớn"] },
    { chinese: "教", pinyin: "jiāo / jiào", english: ["to teach / teaching, religion"], vietnamese: ["dạy / giáo"] },
    { chinese: "教师", pinyin: "jiào shī", english: ["teacher"], vietnamese: ["giáo viên"] },
    { chinese: "教练", pinyin: "jiào liàn", english: ["coach", "instructor"], vietnamese: ["huấn luyện viên"] },
    { chinese: "教会", pinyin: "jiào huì", english: ["church"], vietnamese: ["giáo hội", "nhà thờ"] },
    { chinese: "请教", pinyin: "qǐng jiào", english: ["to ask for advice", "to consult"], vietnamese: ["thỉnh giáo", "xin chỉ bảo"] },
    { chinese: "整", pinyin: "zhěng", english: ["whole", "entire", "to organize"], vietnamese: ["chỉnh", "nguyên", "sắp xếp"] },
    { chinese: "整理", pinyin: "zhěng lǐ", english: ["to organize", "to tidy up"], vietnamese: ["chỉnh lý", "sắp xếp"] },
    { chinese: "整天", pinyin: "zhěng tiān", english: ["all day", "the whole day"], vietnamese: ["cả ngày"] },
    { chinese: "整整", pinyin: "zhěng zhěng", english: ["whole", "full"], vietnamese: ["tròn", "nguyên vẹn"] },
    { chinese: "根", pinyin: "gēn", english: ["root", "basis"], vietnamese: ["rễ", "căn", "gốc"] },
    { chinese: "根据", pinyin: "gēn jù", english: ["according to", "basis"], vietnamese: ["căn cứ", "dựa theo"] },
    { chinese: "根本", pinyin: "gēn běn", english: ["at all", "simply", "fundamental"], vietnamese: ["căn bản", "hoàn toàn"] },
    { chinese: "检", pinyin: "jiǎn", english: ["to check", "to examine"], vietnamese: ["kiểm"] },
    { chinese: "检查", pinyin: "jiǎn chá", english: ["to examine", "examination"], vietnamese: ["kiểm tra"] },
    { chinese: "脸", pinyin: "liǎn", english: ["face"], vietnamese: ["mặt", "khuôn mặt"] },
    { chinese: "脸色", pinyin: "liǎn sè", english: ["complexion", "facial expression"], vietnamese: ["sắc mặt"] },
    { chinese: "简", pinyin: "jiǎn", english: ["simple", "brief"], vietnamese: ["giản", "đơn giản"] },
    { chinese: "简单", pinyin: "jiǎn dān", english: ["simple"], vietnamese: ["đơn giản"] },
    { chinese: "简体", pinyin: "jiǎn tǐ", english: ["simplified form"], vietnamese: ["giản thể"] },
    { chinese: "简直", pinyin: "jiǎn zhí", english: ["simply", "virtually"], vietnamese: ["quả thực", "thật là"] },
    { chinese: "算", pinyin: "suàn", english: ["to count", "to calculate"], vietnamese: ["tính", "toán"] },
    { chinese: "就算", pinyin: "jiù suàn", english: ["even if"], vietnamese: ["cho dù", "ngay cả khi"] },
    { chinese: "总算", pinyin: "zǒng suàn", english: ["finally", "at long last"], vietnamese: ["cuối cùng", "sau cùng"] },
    { chinese: "算了", pinyin: "suàn le", english: ["let it go", "forget about it"], vietnamese: ["thôi đi", "bỏ đi"] },
    { chinese: "管", pinyin: "guǎn", english: ["to manage", "to control", "pipe"], vietnamese: ["quản", "ống"] },
    { chinese: "不管", pinyin: "bù guǎn", english: ["no matter", "regardless of"], vietnamese: ["bất kể", "cho dù"] },
    { chinese: "主管", pinyin: "zhǔ guǎn", english: ["supervisor", "person in charge"], vietnamese: ["chủ quản", "người phụ trách"] },
    { chinese: "保管", pinyin: "bǎo guǎn", english: ["to store", "to guarantee"], vietnamese: ["bảo quản", "cam đoan"] },
    { chinese: "害", pinyin: "hài", english: ["harm", "evil", "calamity"], vietnamese: ["hại", "tai hại"] },
    { chinese: "害怕", pinyin: "hài pà", english: ["to be afraid", "to fear"], vietnamese: ["sợ hãi", "sợ"] },
    { chinese: "有害", pinyin: "yǒu hài", english: ["harmful"], vietnamese: ["có hại"] },
    { chinese: "容", pinyin: "róng", english: ["to contain", "appearance"], vietnamese: ["dung", "chứa đựng", "dong"] },
    { chinese: "容易", pinyin: "róng yì", english: ["easy"], vietnamese: ["dễ dàng", "dễ"] },
    { chinese: "笑容", pinyin: "xiào róng", english: ["smile"], vietnamese: ["nụ cười"] },
    { chinese: "宾", pinyin: "bīn", english: ["guest", "visitor"], vietnamese: ["khách", "tân"] },
    { chinese: "宾馆", pinyin: "bīn guǎn", english: ["hotel", "guesthouse"], vietnamese: ["nhà khách", "khách sạn"] },
    { chinese: "外宾", pinyin: "wài bīn", english: ["foreign guest"], vietnamese: ["khách nước ngoài"] },
    { chinese: "贵宾", pinyin: "guì bīn", english: ["honored guest", "VIP"], vietnamese: ["khách quý", "quý khách"] },
    { chinese: "理", pinyin: "lǐ", english: ["reason", "logic", "to manage"], vietnamese: ["lý", "lí"] },
    { chinese: "理由", pinyin: "lǐ yóu", english: ["reason", "excuse"], vietnamese: ["lý do"] },
    { chinese: "理解", pinyin: "lǐ jiě", english: ["to understand", "to comprehend"], vietnamese: ["lý giải", "hiểu"] },
    { chinese: "无理", pinyin: "wú lǐ", english: ["unreasonable"], vietnamese: ["vô lý"] },
    { chinese: "合情合理", pinyin: "hé qíng hé lǐ", english: ["fair and reasonable"], vietnamese: ["hợp tình hợp lý"] },
    { chinese: "班", pinyin: "bān", english: ["class", "team", "shift (work)"], vietnamese: ["lớp", "ca làm việc", "ban"] },
    { chinese: "加班", pinyin: "jiā bān", english: ["to work overtime"], vietnamese: ["tăng ca", "làm thêm giờ"] },
    { chinese: "环", pinyin: "huán", english: ["ring", "loop", "link"], vietnamese: ["vòng", "khâu", "hoàn"] },
    { chinese: "环节", pinyin: "huán jié", english: ["link", "sector", "segment"], vietnamese: ["khâu", "mắt xích"] },
    { chinese: "超", pinyin: "chāo", english: ["super", "to surpass"], vietnamese: ["siêu", "vượt quá"] },
    { chinese: "超级", pinyin: "chāo jí", english: ["super"], vietnamese: ["siêu cấp", "cực kỳ"] },
    { chinese: "超市", pinyin: "chāo shì", english: ["supermarket"], vietnamese: ["siêu thị"] },
    { chinese: "超过", pinyin: "chāo guò", english: ["to surpass", "to exceed"], vietnamese: ["vượt quá", "vượt qua"] },
    { chinese: "越", pinyin: "yuè", english: ["to surpass", "more"], vietnamese: ["việt", "vượt", "càng"] },
    { chinese: "超越", pinyin: "chāo yuè", english: ["to surpass", "to transcend"], vietnamese: ["vượt qua"] },
    { chinese: "越来越", pinyin: "yuè lái yuè", english: ["more and more"], vietnamese: ["ngày càng", "càng ngày càng"] },
    { chinese: "趣", pinyin: "qù", english: ["interesting", "interest"], vietnamese: ["thú", "hứng thú"] },
    { chinese: "乐趣", pinyin: "lè qù", english: ["joy", "delight"], vietnamese: ["niềm vui", "thú vui", "lạc thú"] },
    { chinese: "兴趣", pinyin: "xìng qù", english: ["interest"], vietnamese: ["hứng thú"] },
    { chinese: "定", pinyin: "dìng", english: ["definite", "certain", "to set"], vietnamese: ["định"] },
    { chinese: "决定", pinyin: "jué dìng", english: ["to decide", "decision"], vietnamese: ["quyết định"] },
    { chinese: "一定", pinyin: "yī dìng", english: ["definitely", "must"], vietnamese: ["nhất định"] },
    { chinese: "说不定", pinyin: "shuō bu dìng", english: ["maybe", "perhaps"], vietnamese: ["chưa biết chừng", "có lẽ"] },
    { chinese: "蛋", pinyin: "dàn", english: ["egg"], vietnamese: ["trứng"] },
    { chinese: "完蛋", pinyin: "wán dàn", english: ["finished", "done for", "ruined"], vietnamese: ["xong đời", "tiêu tùng", "hư hỏng"] },
    { chinese: "坏蛋", pinyin: "huài dàn", english: ["bad guy", "scoundrel"], vietnamese: ["kẻ xấu", "đồ khốn"] },
    { chinese: "楚", pinyin: "chǔ", english: ["clear", "pain"], vietnamese: ["sở", "rõ ràng"] },
    { chinese: "清楚", pinyin: "qīng chu", english: ["clear", "to understand"], vietnamese: ["rõ ràng"] },
    { chinese: "曾", pinyin: "céng", english: ["once", "before"], vietnamese: ["từng"] },
    { chinese: "曾经", pinyin: "céng jīng", english: ["once", "previously"], vietnamese: ["đã từng"] },
    { chinese: "不曾", pinyin: "bù céng", english: ["never"], vietnamese: ["chưa từng"] },
    { chinese: "增", pinyin: "zēng", english: ["to increase", "to add"], vietnamese: ["tăng"] },
    { chinese: "增加", pinyin: "zēng jiā", english: ["to increase", "to add"], vietnamese: ["tăng thêm", "gia tăng"] },
    { chinese: "增长", pinyin: "zēng zhǎng", english: ["to grow", "to increase"], vietnamese: ["tăng trưởng"] },
    { chinese: "境", pinyin: "jìng", english: ["border", "circumstance"], vietnamese: ["cảnh"] },
    { chinese: "环境", pinyin: "huán jìng", english: ["environment", "surroundings"], vietnamese: ["môi trường"] },
    { chinese: "出境", pinyin: "chū jìng", english: ["to leave the country", "departure"], vietnamese: ["xuất cảnh"] },
    ]
