...
const vocab = [
    ...
    { chinese: "水", pinyin: "shuǐ", english: ["water"], vietnamese: ["thủy", "nước"] },
    { chinese: "火", pinyin: "huǒ", english: ["fire"], vietnamese: ["hỏa", "lửa"] },
    ...
    { chinese: "本人", pinyin: "běnrén", english: ["oneself", "my self"], vietnamese: ["bản thân", "chính mình"] },
