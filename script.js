...
const vocab = [
    ...
    { chinese: "名", pinyin: "míng", english: ["name", "fame"], vietnamese: ["tên", "danh"] },
    ...
    { chinese: "出名", pinyin: "chū míng", english: ["famous", "well-known"], vietnamese: ["nổi tiếng", "nổi danh"] },
    { chinese: "外", pinyin: "wài", english: ["outside", "foreign"], vietnamese: ["ngoài", "ngoại"] },
    ...
    { chinese: "应", pinyin: "yīng", english: ["should"], vietnamese: ["nên/cần/phải", "ưng"] },
    { chinese: "应该", pinyin: "yīng gāi", english: ["should", "ought to"], vietnamese: ["nên/cần phải (2 từ)", "nên"] },
    { chinese: "买", pinyin: "mǎi", english: ["buy"], vietnamese: ["mua/sắm/tậu", "mãi"] },
    { chinese: "头", pinyin: "tóu", english: ["head"], vietnamese: ["cái đầu"] },
]
